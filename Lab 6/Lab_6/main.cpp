...
//  Lab_6
//
//  Created by Claudiu Hiticas on 11/25/19.
...
inline void readPoly(string filename, int &n, vector <int> &a, vector<int> &b)
{
...
int main(int argc, const char * argv[])
{
    int n;
    vector <int> a, b;
    string path = "/Users/claudiuhiticas/Desktop/University/PPD/Lab_6/Lab_6/tests1.in";
    readPoly(path,n, a, b);
